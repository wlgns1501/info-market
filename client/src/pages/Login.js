    ...
    <div>
      ...
      <div className='login-container'>
        <div className='login-input'>
          ...
          />
          <div>
            <button className='button' type='submit' onClick={handleLogin}>로그인</button>
          ...
          <div>
            <div>
              <button className="kakao-login" onClick={() => handleOauth(kakaoOauth)} ref={kakaoOauth}>
                카카오 로그인
              </button>
              <button className="naver-login" onClick={() => handleOauth(naverOauth)} ref={naverOauth}>
                네이버 로그인
              </button>
            </div>
            <div>
