...
module.exports = {
    ...
    writeInfo: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (type !== 'Free' && (user === null || user === void 0 ? void 0 : user.grade) === 'Bronze') {
        ...
        const info = yield infoDb.createInfo(title, content, targetPoint, type, user.id, activate, req.body.file);
        return res
            .status(203)
    ...
    removeInfo: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if ((user === null || user === void 0 ? void 0 : user.id) !== info.userId) {
    ...
    editFile: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (info.userId != (user === null || user === void 0 ? void 0 : user.id)) {
            return res.status(403).json({ message: '유저가 일치하지 않습니다.' });
        }
